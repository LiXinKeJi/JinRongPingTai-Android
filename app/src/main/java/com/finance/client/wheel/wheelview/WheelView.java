package com.finance.client.wheel.wheelview;
...
import com.finance.client.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    private int[] SHADOWS_COLORS = new int[]{0xFFFFF,0xCCCCCC, 0x999999};//浅灰，灰，浅黑
