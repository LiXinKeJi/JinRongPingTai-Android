...
public class LogOutDialog extends Dialog implements
    ...
    public LogOutDialog(Context context, String tips,
    ...
    public LogOutDialog(Context context, int tips,
        ...
        tv_tips = (TextView) findViewById(R.id.log_out_tips_tv);
        cancelButton = (Button) findViewById(R.id.log_out_tips_btn_cancel);
        cancelButton.setOnClickListener(this);
        sureButton = (Button) findViewById(R.id.log_out_tips_btn_sure);
